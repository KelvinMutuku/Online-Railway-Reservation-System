...
<head>
  ...
  <body class="be-splash-screen">
    <div class="be-wrapper be-login" style="background-image: url(assets/img/img-2.jpg); background-size:cover;">
      <div class="be-content">
        <div class="main-content container-fluid">
          <div class="splash-container">
            <div class="card card-border-color card-border-color-danger" style="background-color:transparent;">
              <div class="card-header"><img class="logo-img" src="assets/img/logo-xx.png" alt="logo" width="{conf.logoWidth}" height="27"><span class="splash-description" style="color:#fff;">Admin Login Panel</span></div>
              <div class="card-body">
                ...
                <form method ="POST">
                  <div class="login-form ">
                    ...
                    <div class="form-group" style="color:#fff;">
                      <input class="form-control" name="admin_email" type="text" placeholder="Email" autocomplete="off" style="background-color:transparent; color:#fff;">
                    </div>

                    <div class="form-group">
                      <input class="form-control" name="admin_pwd" type="password" placeholder="Password" style="background-color:transparent; color:#fff;">
                    </div>
