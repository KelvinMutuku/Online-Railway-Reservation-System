				...
				<!-- Banner -->
					<section id="banner">
						<div class="inner">
							...
							<p>Fast, Simple, and a User Friendly Way To Reserve Train Tickets Effectively</a></p>
						</div>
					</section>
					...
					<section id="footer">
						<div class="inner">
							...
							<ul class="contact">
								...
								<li class="icon solid fa-phone">(+254) 712987215</li>
								<li class="icon solid fa-envelope"><a href="#">orrs@gmail.com</a></li>
