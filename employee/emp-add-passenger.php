  ...
  <body style="background-image: url(assets/img/img-1.jpg); background-size:fit; background-repeat:no-repeat;">
    ...
    <!--Navigation Bar-->
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title" style="color:#fff !important;">Create Passenger</h2>
          <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
              <li class="breadcrumb-item"><a href="pass-dashboard.php" style="color:#fff !important;">Dashboard</a></li>
              <li class="breadcrumb-item"><a href="#" style="color:#fff !important;">Passenger</a></li>
              <li class="breadcrumb-item active" style="color:#fff !important;">Add</li>
            </ol>
          </nav>
        </div>
