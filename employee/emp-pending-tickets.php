 ...
 <!-- end HEAD--> 
  <body style="background-image: url(assets/img/img-1.jpg); background-size:fit; background-repeat:no-repeat;">
    ...
    <!--navbar-->
      ...
      <div class="page-head">
          <h2 class="page-head-title" style="color:#fff !important;">Pending Approval Tickets</h2>
          <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
              ...
              <li class="breadcrumb-item active" style="color:#fff !important;">View Pending</li>
            </ol>
          </nav>
        </div>
        <?php if(isset($succ)) {?>
